        ...
        <div>
            <div className='fullGameMargin instructions-back'>
                ...
                <div style={{justifyContent:'center', alignItems:'center', textAlign:'center'}}>
                    ...
                    <div style={{fontFamily:'Poppins-SemiBold', fontSize:'30px', marginBottom: '10vh'}}> We will show you <span className='highlight'>pairs of shapes</span>. You need to decide if the <span className='highlight'>shapes</span> are the <span className='highlight'>same</span> or not
                    </div>
                </div>
